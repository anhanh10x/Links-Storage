    ...
    public class CustomButton : Button
    {
        ...
        public int BorderSize
        {
            ...
            set
            {
                if(value<0)
                {
                    Exception e = new Exception("Wrong. Border size must be greater than or equal 0");
                    throw e;
                }
                borderSize = value;
                this.Invalidate();
        ...
        public bool Transparent
        {
            ...
            set { this.transparent = value; this.Button_BackGroundChange(); }
        }
        ...
        private void Button_BackGroundChange()
        {
